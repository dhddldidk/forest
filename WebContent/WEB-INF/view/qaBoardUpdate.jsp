...
<jsp:include page="header.jsp"/>
	...
	<div id="content">
		...
		<div id="content_content">
			...
			<div id="divWrite">
				<form action="qaBoardUpdateResult.do" method="post" enctype="multipart/form-data">
					<div id="divt1">
						<label>제목</label>
						<input type="hidden" name="no" value="${question.qNo }">
						<input type="text" name="title" value="${question.qTitle }">
					</div>
					<div id="divcontent">
						<label>내용</label>
					...
					<div id="divFile">
						<label>첨부된 파일</label>
							<input type="text" name="oldfile" value="${question.qUpload }" id="spanfile" readonly="readonly">
						<span id="deletefile"><img src="/forest/css/images/intro/file_delete.png" id="imgdel"></span>
					</div>
					<div id="divFile">
						<label>파일 첨부</label>
						<input type="file"  name="file1" id="filechk">
					</div>
					<div id="btn">
