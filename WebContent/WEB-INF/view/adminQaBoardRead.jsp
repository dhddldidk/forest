...
<script type="text/javascript">
	$(function(){
		...
		$("#btndelete").click(function(){
			...
			if(con){
				location.href="adminQaBoardDelete.do?key=${question.qNo}";
			}
		})
	})
</script>
...
<jsp:include page="header.jsp"/>
	...
	<div id="content">
		...
		<div id="content_content">
			...
			<!-- form -->
			<form action="adminQaBoardUpdate.do" method="post">
				...
				<div id="divid">
				  ...
				  <div id="divabtn">
				  <c:if test="${question.answer.aContent==null}">
				  	<button>글쓰기</button>
				  </c:if>
				   <c:if test="${question.answer.aContent!=null}">
				  	<button>수정</button>
				  ...
				  <a href="#" id="btndelete">삭제</a>
				  	...
				  	<a href="adminQaBoard.do?pa=1">목록</a>
