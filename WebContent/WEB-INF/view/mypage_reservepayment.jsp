...
<style>
	*{
	...
	#pay_info #pay_info_ul_list ul#ul1{
	 ...
	 #pay_info #pay_info_ul_list ul#ul1 li span:LAST-CHILD{
	  	margin-left:25px;
	 }
		...
		<div id="reservepayment_info">
			...
			<div id="pay_info">
				...
				<div id="pay_info_ul_list">
					...
					<ul id="ul2">
						<li><span class="pay_info_ul_li_color">최종 결제 금액</span><span id="ul2_fontsize"><fmt:formatNumber value="${list.res_fprice }" type="number"/></span>원</li>
					</ul>
				</div>	
			</div>
			<div id="pay_button">				
					...
					<input type="submit" value="결제" id="btnresult">										
			</div>
		</div>
	</div>
	</form>
