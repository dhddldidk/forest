...
public class Reservation {
	...
	public Reservation(String res_no, String res_info, Date res_save, Date res_now, int res_state, Date res_paydate,
			Date res_startdate, Date res_enddate, String room_info, Date res_stay, int res_price, int res_his,
			int fprice, int r_no, String u_id) {
		super();
		this.res_no = res_no;
	...
	public Date getRes_stay() {
		return res_stay;
	}
	public void setRes_stay(Date res_stay) {
		this.res_stay = res_stay;
	}
	...
	public String toString() {
		return "Reservation [res_no=" + res_no + ", res_info=" + res_info + ", res_save=" + res_save + ", res_now="
				+ res_now + ", res_state=" + res_state + ", res_paydate=" + res_paydate + ", res_startdate="
				+ res_startdate + ", res_enddate=" + res_enddate + ", room_info=" + room_info + ", res_stay=" + res_stay
				+ ", res_price=" + res_price + ", res_his=" + res_his + ", fprice=" + fprice + ", r_no=" + r_no
				+ ", u_id=" + u_id + "]";
	}
